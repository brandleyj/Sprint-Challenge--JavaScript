...
zooAnimals.forEach(function(i) {
	displayNames.push(
		"Name: " + i.animal_name + ", Scientific name: " + i.scientific_name
	);
});
...
populationTotal = zooAnimals.reduce((totalPop, animals) => {
	return totalPop + animals.population;
}, 0);
